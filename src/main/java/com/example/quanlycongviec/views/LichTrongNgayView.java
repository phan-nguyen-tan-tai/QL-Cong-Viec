...
public class LichTrongNgayView extends BorderPane {
    ...
    public LichTrongNgayView(Runnable onBack) {
        ...
        centerContainer.getChildren().add(new Label("[Giao diện Lịch trình]"));
        this.setCenter(centerContainer);
        this.setPrefSize(500, 400);
    }

    public void showLichTrongNgay() {
        switchCenter(new Label("[Giao diện Lịch trình]"));
    }

    public void showSua() {
        switchCenter(new Label("[Giao diện Sửa lịch trình]"));
    }

    public void showLuu() {
        switchCenter(new Label("[Giao diện Lưu lịch trình]"));
    }

    public void showXoa() {
        switchCenter(new Label("[Giao diện Xoá lịch trình]"));
    }
